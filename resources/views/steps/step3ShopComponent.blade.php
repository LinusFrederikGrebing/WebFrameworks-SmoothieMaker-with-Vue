          ...
          <div class="flex test w-100">
            <div class="px-4 basis-3/5">
              <div class="flex">
                ...
                <button onclick="removeAll()" href="{{ route('removeAll') }} "
                    class="button-87 redbg removeAll d-flex">
                ...
                <tbody>
                    @if (Gloudemans\Shoppingcart\Facades\Cart::count() > 0)
                        @foreach (Gloudemans\Shoppingcart\Facades\Cart::content() as $item)
                            <tr>
                                <td class=""><img src="/images/{{ $item->options->image }}"
                                        class="w-50">
                                </td>
                                ...
                                <td class="text-center" data-title="stock">
                                    <div class="flex">
                                        ...
                                        <form action="/decreaseCardQty/{{ $item->rowId }}"
                                            enctype="multipart/form-data" method="post">
                                            @csrf
                                            <button onclick="removeOne()" class="btn"><svg
