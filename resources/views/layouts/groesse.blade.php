...
<p> Aktuell hast du <b id="cart-counter2">{{ Gloudemans\Shoppingcart\Facades\Cart::count() }}</b> von <b>{{ session()->get('bottle')->amount }}</b> für Größe {{ session()->get('bottle')->name }} benötigte Zutaten ausgewählt. </p>
<hr class="w-75">
